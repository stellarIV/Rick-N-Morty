...
<div class="container mx-auto px-5 py-24">
    ...
    <div class="mb-12 flex w-full flex-col text-center">
      ...
      <p class="mx-auto text-base leading-relaxed lg:w-2/3">Feel free to reach out to me! Whether you have a question,
        feedback, or a collaboration proposal, we'd love to hear from you. also here is my Figma work
        <a href="https://www.figma.com/design/LtSDa8zvqqyVMroLl8jfBm/Rick-%26-Morty?node-id=0%3A1&t=KHqGe2625PdtY2Yy-1" target="_blank" class="text-orange-500 hover:underline duration-300">Click me</a>
      </p>
    </div>
    ...
    <div class="mx-auto md:w-2/3 lg:w-1/2">
      <div class="-m-2 flex flex-wrap">
        ...
        <div class="w-full p-2">
          <button type="submit" class="mx-auto flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none">submit</button>
        </div>


        <!-- footer -->
        <div class="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
          <a href="mailto:Biruktml@gmail.com"class="text-indigo-400">Biruktml@gmail.com</a>
          <p class="my-5 leading-normal">Kebele-08 <br />BDU, Poly Capmus</p>
